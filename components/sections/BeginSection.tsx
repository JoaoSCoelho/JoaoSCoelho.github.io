...
export const BeginSection = ({}: BeginSectionProps) => {
  return (
    <div className="h-[calc(100dvh-80px)] relative flex px-16 items-center justify-between overflow-hidden">
      ...
      <div className="absolute left-1/2 -translate-x-1/2 w-200 h-200 bg-linear-to-br from-[#bddcff6c] -z-10 to-transparent rounded-full"></div>
      <div className="w-full h-[90%] self-end relative">
        <Image
          src="/my-photo.png"
          fill
        ...
        <div className="w-full self-start flex justify-end -mt-15">
          <div className="self-end">
            <div className="relative w-30 h-50 rounded-md mb-6">
              <Image src="/chatbot-mock.png" fill className="object-contain" alt="Website mockup" />
            </div>
            <div className="relative">
              <span className="bg-gray-900 rounded-full w-5 h-5 absolute -top-2.5 left-1/2 -translate-x-1/2"></span>
        ...
        <div className="w-1/2 self-start flex justify-end -mt-10">
          <div className="self-end">
            <div className="relative w-60 h-38 rounded-md mb-10">
              <Image src="/api-mock.png" fill className="object-contain" alt="Website mockup" />
            </div>
            <div className="relative">
              <span className="bg-gray-900 rounded-full w-5 h-5 absolute -top-2.5 left-1/2 -translate-x-1/2"></span>
